...
public class ServletCookieTest {
  ...
  public void testCommonMethods() {
    Cookie cookie1 = new ServletCookie(newServletCookie("comment1"));
    Cookie cookie2 = new ServletCookie(newServletCookie("comment1"));
    Cookie cookie3 = new ServletCookie(newServletCookie("comment3"));
  ...
  private static javax.servlet.http.Cookie newServletCookie(String comment) {
    ...
    servletCookie.setComment(comment);
    servletCookie.setMaxAge(1);
