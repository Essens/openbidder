...
public class ServletTestUtils {
  ...
  public static HttpServletRequest newHttpRequest(String method, @Nullable byte[] content,
      String requestUrl, String paramName, String paramValue,
      String headerName, String headerValue, Cookie cookie) throws IOException {
  ...
  static class TestServletInputStream extends ServletInputStream {
    ...
    TestServletInputStream(byte[] bytes) {
