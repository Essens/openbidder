...
public class StandardCookie extends AbstractCookie {
   ...
   */
  protected StandardCookie(String name, String value, @Nullable String domain, @Nullable String path,
  ...
  public static Cookie create(String name, String value) {
    return new StandardCookie(name, value, null, null, false, null, 0, 0);
  }
