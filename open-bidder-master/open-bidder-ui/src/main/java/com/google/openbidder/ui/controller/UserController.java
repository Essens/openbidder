...
/**
 * RESTful API controller for {@link UserResource}s.
 */
@Controller
@RequestMapping("/projects/{parentResourceName}/users")
public class UserController extends ResourceController<UserResource> {

  @Inject
  public UserController(UserResourceService userResourceService) {
