...
/**
 * Transforms an {@link InstanceType#getInstanceType()} into a {@link InstanceType}.
 */
public class InstanceTypeDeserializer extends JsonDeserializer<InstanceType> {

  @Override
  public InstanceType deserialize(
      JsonParser jp,
      DeserializationContext ctxt) throws IOException {

    return InstanceType.fromInstanceType(jp.getText());
  }
}
