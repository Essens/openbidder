 ...
 *   <dd>URL example: https://www.googleapis.com/compute/v1beta16/projects/google.com:open-source-bidder/global/networks/network-0cc37e1147da4215af028632f6960b34</dd>
 *   <dd>For per-zone resources eg instances, machine types</dd>
 *   <dd>URL example: https://www.googleapis.com/compute/v1beta16/projects/google.com:open-source-bidder/zones/rtb-us-east2/instances/load-balancer-1340002895954</dd>
 *   <dt>Long</dt>
...
public class ResourceName {
  ...
  public static ResourceName parseResource(String resourceUrlParam) {
    ...
    if (parts.length > 1) {
      ...
      Preconditions.checkNotNull(computeResourceType,
