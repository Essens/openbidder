...
public enum InstanceType {
  ...
  private static final Map<String, InstanceType> LOOKUP = ImmutableMap.copyOf(
      Maps.uniqueIndex(ImmutableList.copyOf(values()), new Function<InstanceType, String>() {
        @Override
        public String apply(InstanceType instanceType) {
  ...
  public static boolean hasTag(Instance instance, String tag) {
    return  instance.getTags() != null
        ...
        && instance.getTags().getItems().contains(Preconditions.checkNotNull(tag));
  }
