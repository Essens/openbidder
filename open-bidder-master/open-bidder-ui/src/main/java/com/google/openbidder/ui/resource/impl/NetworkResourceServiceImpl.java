...
public class NetworkResourceServiceImpl
  ...
  public NetworkResourceServiceImpl(
    ...
    this.networkBuilder = Preconditions.checkNotNull(networkBuilder);
    this.firewallBuilder = Preconditions.checkNotNull(firewallBuilder);
  ...
  protected NetworkResource create(
    ...
    project = getProjectService().updateProject(projectUser.getProject().getId(),
        new Function<Project, Project>() {
          @Override
          public Project apply(@Nullable Project project) {
  ...
  private NetworkResource getNetwork(
    ...
    if (includeFirewalls) {
      ...
      networkResource.setFirewalls(Lists.transform(firewalls,
          new Function<Firewall, FirewallResource>() {
            @Override
            public FirewallResource apply(Firewall firewall) {
