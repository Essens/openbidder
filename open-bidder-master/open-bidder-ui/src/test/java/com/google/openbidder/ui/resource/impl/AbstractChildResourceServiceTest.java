...
public class AbstractChildResourceServiceTest {
  ...
  private static class TestResourceService
    ...
    @Override
    protected Parent getParent(String resourceName) {
    ...
    @Override
    protected List<? extends Child> list(
        Parent parentResource,
        ResourceCollectionId resourceCollectionId,
        Multimap<String, String> params) {
    ...
    @Override
    protected void delete(Parent parentResource, ResourceId resourceId) {
