...
public class ResourceTest {
  ...
  private static final Set<String> MANDATORY_PROPERTIES = ImmutableSet.of(
      "id",
      "resourceName",
      "resourceType",
      "resourceUri"
  ...
  private static final Set<String> READ_ONLY_PROPERTIES = ImmutableSet.of(
      "resourceName",
      "resourceType",
      "resourceUri"
  );
  ...
  private static class Property {
    ...
    public boolean has(Object obj) {
      Preconditions.checkState(status != null, "no status method");
      try {
    ...
    public <T> T get(Object obj) {
      Preconditions.checkState(value != null, "no value method");
      Preconditions.checkState(value.getReadMethod() != null, "no getter on value method");
      try {
    ...
    public <T> void set(Object obj, T newValue) {
      Preconditions.checkState(value != null, "no value method");
      Preconditions.checkState(value.getWriteMethod() != null, "no setter on value method");
      try {
    ...
    public void clear(Object obj) {
      Preconditions.checkState(clear != null, "no clear method");
      try {
        clear.invoke(obj);
      } catch (ReflectiveOperationException e) {
