...
public class GoogleCloudStorageImpl implements GoogleCloudStorage {
  ...
  public StorageObject getObject(
    ...
    return executeRequest(objectUrl, new HttpRequestFunction<StorageObject>() {
      @Override
      public StorageObject apply(GenericUrl url) throws IOException {
        HttpRequest request = requestFactory.buildGetRequest(url);
        ...
        if (ifModifiedSince != null) {
          ...
          // will be returned.
          request.getHeaders().put(com.google.common.net.HttpHeaders.IF_MODIFIED_SINCE,
              Arrays.asList(GoogleCloudStorageUtil.instantToLastModifiedString(ifModifiedSince)));
        }
