...
public class WeatherServiceOpenWeatherMap implements WeatherService {
  ...
  private static final Set<String> FIELDS_ROOT = ImmutableSet.of("main", "wind");
  private static final Set<String> FIELDS_MAIN = ImmutableSet.of("temp", "humidity");
  private static final Set<String> FIELDS_WIND = ImmutableSet.of("speed");
