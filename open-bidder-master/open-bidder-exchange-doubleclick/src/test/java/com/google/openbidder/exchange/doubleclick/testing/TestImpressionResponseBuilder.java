 ...
 */
public class TestImpressionResponseBuilder
extends com.google.openbidder.api.testing.impression.TestImpressionResponseBuilder {
  ...
  // to change tests if later releases need a DoubleClick-specific ImpressionResponse.
}
