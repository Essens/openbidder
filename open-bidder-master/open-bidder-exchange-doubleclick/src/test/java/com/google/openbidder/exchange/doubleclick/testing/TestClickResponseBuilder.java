 ...
 */
public class TestClickResponseBuilder
extends com.google.openbidder.api.testing.click.TestClickResponseBuilder {
  ...
  // to change tests if later releases need a DoubleClick-specific ClickResponse.
}
