...
/**
 * Tests for {@link UserResponse}.
 */
public class UserResponseTest {

  @Test
  public void testCommonMethods() {
    TestUtil.testCommonMethods(newResponse("1"));
  }

  private static UserResponse<?> newResponse(String metadata) {
    return TestBidResponseBuilder.create().build().putMetadata("meta", metadata);
  }
}
