...
public class InterceptorAbortException extends RuntimeException {
  ...
  public InterceptorAbortException(@Nullable String m) {
    super(m);
  }

  public InterceptorAbortException(@Nullable String m, @Nullable Throwable t) {
    super(m, t);
  }

  public InterceptorAbortException(@Nullable Throwable t) {
    super(t);
  }
}
