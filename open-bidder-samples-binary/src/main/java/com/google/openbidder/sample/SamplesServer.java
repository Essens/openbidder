...
import mobitrans.openbidder.exchange.MyExchangeModule;
import com.google.openbidder.storage.dao.StorageModule;
import com.google.openbidder.weather.config.WeatherModule;
...
public class SamplesServer extends BidderServer {
      ...
      private static final Logger logger = LoggerFactory.getLogger(SamplesServer.class);
    ...
    public static void main(String[] args) {
        ...
        if (args.length == 0) {
            ...
            args[3] = "--p12_file_path=D:\\TFSProjects\\rtb\\Code\\bidder.p12";
            args[4] = "--bid_interceptors=com.google.openbidder.sample.bidding.RandomBidInterceptor";
            args[5] = "--impression_interceptors=";
