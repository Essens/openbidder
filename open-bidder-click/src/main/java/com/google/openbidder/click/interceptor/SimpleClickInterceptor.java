...
package com.google.openbidder.click.interceptor;
...
/**
 * A simple click tracking interceptor.
 */
public class SimpleClickInterceptor implements ClickInterceptor {

  private static final Logger logger = LoggerFactory.getLogger(SimpleClickInterceptor.class);

  @Override
  public void execute(InterceptorChain<ClickRequest, ClickResponse> chain) {
    if (logger.isDebugEnabled()) {
      logger.debug("Received click: {}", chain.request());
    }
