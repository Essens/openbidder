...
import com.google.openbidder.servlet.ServletHttpRequest;
import com.google.openbidder.servlet.ServletHttpResponseBuilder;
...
public class ReceiverServlet extends HttpServlet {
  private final ImmutableMap<Integer, HttpRouter> httpRouters;

  public ReceiverServlet(Map<Integer, HttpRouter> httpRouters) {
    this.httpRouters = ImmutableMap.copyOf(httpRouters);
  }
  ...
  protected void service(HttpServletRequest req, HttpServletResponse resp)
    ...
    httpRouters.get(req.getServerPort()).receive(
        new DefaultHttpReceiverContext(new ServletHttpRequest(req), httpResponseBuilder));
