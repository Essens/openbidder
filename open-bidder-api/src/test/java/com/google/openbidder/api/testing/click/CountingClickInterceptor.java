...
/**
 * A click interceptor that monitors its own invocations.
 */
public class CountingClickInterceptor
    extends CountingInterceptor<ClickRequest, ClickResponse>
    implements ClickInterceptor {
}
