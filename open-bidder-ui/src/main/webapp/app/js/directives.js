...
function NavBarController(
    $scope, $routeParams, $location, $q, NoticeQueue, Project, Channel, UserEmail) {
...
openBidderDirectives.directive('instanceTable', function() {
  return {
    ...
    controller: ['$scope', 'Instance', 'NoticeQueue', 'HttpErrorHandler',
        function($scope, Instance, NoticeQueue, HttpErrorHandler) {
