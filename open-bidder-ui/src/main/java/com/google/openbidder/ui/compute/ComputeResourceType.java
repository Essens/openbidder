...
public enum ComputeResourceType {
  ...
  private static final ImmutableMap<ResourceType, ComputeResourceType> MAPPING =
  ...
  public static final Function<ComputeResourceType, String> GET_NAME =
      new Function<ComputeResourceType, String>() {
        @Override public String apply(ComputeResourceType type) {
          return type.getType();
        }};

  public static final ImmutableMap<String, ComputeResourceType> VALUES =
  ...
  public static ComputeResourceType fromResourceType(ResourceType resourceType) {
    return MAPPING.get(checkNotNull(resourceType));
  }
}
