...
public enum ResourceType {
  ...
  private static final ImmutableMap<String, ResourceType> RESOURCE_TYPES = ImmutableMap.copyOf(
      Maps.uniqueIndex(asList(values()), new Function<ResourceType, String>() {
        @Override public String apply(ResourceType resourceType) {
  ...
  public ResourceCollectionId getResourceCollectionId(String... ancestorResourceNames) {
    return getResourceCollectionId(asList(ancestorResourceNames));
  }
  ...
  public ResourceCollectionId getResourceCollectionId(List<String> ancestorResourceNames) {
    ...
    checkArgument(actualAncestorDepth == expectedAncestorDepth,
  ...
  public ResourceId getResourceId(String... resourceNames) {
    return getResourceId(asList(resourceNames));
  }
  ...
  public static ResourcePath parseResourceUri(String resourceUri) {
    ...
    for (String part : parts) {
      if (last == name) {
        ...
        checkArgument(resourceType != null, "Unknown resource type '%s'", part);
    ...
    checkArgument(last != null, "no URI entered");
    return last;
  }
}
