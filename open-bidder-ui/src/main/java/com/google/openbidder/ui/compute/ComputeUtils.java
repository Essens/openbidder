...
public class ComputeUtils {
  ...
  public static String findStandardImageProjectApi(String defaultImageName) {
    ...
    return checkNotNull(matchingProjectApi);
  }
  ...
  public static enum ProjectMapper {
    ...
    OPENSUSE_13_2("opensuse-cloud", "^opensuse-13-2.*", true),
    OPENSUSE("opensuse-cloud", "^opensuse-.*", false),
    RHEL_7("rhel-cloud", "^rhel-7-.*", true),
    RHEL("rhel-cloud", "^rhel-.*", false),
    SLES_12("suse-cloud", "^sles-12-.*", false),
    SLES("suse-cloud", "^sles-.*", false),
    UBUNTU_T("ubuntu-os-cloud", "^ubuntu-1404-trusty-.*", true),
    UBUNTU_V("ubuntu-os-cloud", "^ubuntu-1504-vivid-.*", true),
    UBUNTU("ubuntu-os-cloud", "^ubuntu-.*", false),
    ;
