...
public class InstanceFunctionalTest extends OpenBidderFunctionalTestCase {
  ...
  private static final ImmutableMap<String, String> PARAMS_1 = ImmutableMap.<String, String>builder()
      .put("status", "RUNNING")
  ...
  private static final ImmutableMap<String, String> PARAMS_2 = ImmutableMap.<String, String>builder()
  ...
  private static final Function<Map.Entry<String, String>, Metadata.Items> METADATA_ITEM =
      new Function<Map.Entry<String, String>, Metadata.Items>() {
        @Override public Metadata.Items apply(Map.Entry<String, String> entry) {
  ...
  private Instance buildInstance(
    ...
    instance.setNetworkInterfaces(asList(networkInterface));
    return instance;
  }
  ...
  private void configureBidder(
    ...
    instance.setTags(new Tags().setItems(asList(BidderInstanceBuilder.TAG)));
  }
