...
public class DoubleClickModuleTest {
  ...
  private void testModule(boolean enabled) {
    ...
    jcommander.parse(
        ...
        "--doubleclick_local_resources=true",
        ...
        enabled ? "--doubleclick_dumpfile=" + System.getProperty("java.io.tmpdir") : "",
        enabled ? "--doubleclick_raw_request=/raw-doubleclick-request.txt" : "",
        enabled ? "--doubleclick_raw_response=/raw-doubleclick-response.txt" : "",
        enabled ? "--doubleclick_extmappers=" + TestExtMapper.class.getName() : "");
  ...
  public static class TestExtMapper extends ExtMapper {}
}
